...
@endif
	<div class="form-group">
		...
		<div class="form-group row m-12">
			{{html()->label('Ruta','IdRuta')->class(['form-check-label col-lg-2'])}}
			{{html()->select('IdRuta',$Rutas,'')->required()->class(['form-control col-lg-3'])}}
			{{html()->label('Fecha','Fecha')->class(['form-check-label col-lg-2'])}}
