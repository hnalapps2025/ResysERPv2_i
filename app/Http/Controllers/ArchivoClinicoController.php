			...
			if(count($citados)>0)
			{
				...
				$tabla_u.='<table border="1" width="100%" style="font-size:12px">
							<thead>
								<tr style="background-color:#FFFF00;color:#0000FF;">
								  ...
								  <td width="31%" align="center">Servicio</td>
								  <td width="30%" align="center">Ult.Movimiento</td>
								  <td width="10%" align="center">Fe.Ul.Mo</td>
								  <td width="11%" align="center">Paciente</td>
								</tr>
							</thead><tbody>';
				foreach($citados as $i=>$fila_u)
				{
					$tabla_u.='<tr>
								  ...
								  <th width="3%"></th>
								  <th width="31%" style="white-space: nowrap; overflow: hidden;">'.$fila_u->Servicio.'</th>
								  <th width="30%" style="white-space: nowrap; overflow: hidden;">'.$fila_u->donde_esta.'</th>
								  <th width="10%">'.date('d/m/Y',strtotime($fila_u->fecha_um)).'</th>
								  <th width="11%" style="font-size:10px">'.$fila_u->Paciente.'</th>
								</tr>';
				}
				$tabla_u.='</tbody></table>';
				if(strlen($tabla_u)>0)
