   ...
   async listaExamenObstetricia(tipo){
    ...
    $.ajax({
        ...
        success:  function (datos) {  
            ...
            // Columna 1: 
            column1Html +=  EvaluacionEmergencia.generateExamenObstetriciaHtml("ECOGRAFIA ABDOMINAL", examenesPorCategoria["ECOGRAFIA ABDOMINAL"]);  
            column1Html += '</div>';

            // Columna 2: 
            column2Html +=  EvaluacionEmergencia.generateExamenObstetriciaHtml("ECOGRAFIA-VARIOS", examenesPorCategoria["ECOGRAFIA-VARIOS"]);
            column2Html += '</div>'; 
    ...
    async listaExamenRayosX(tipo){
        ...
        $.ajax({
            ...
            success:  function (datos) {  
                ...
                // Columna 1: 
                column1Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA APARATO DIGESTIVO", examenesPorCategoria["RADIOGRAFIA APARATO DIGESTIVO"]);  
                column1Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA CABEZA Y CUELLO", examenesPorCategoria["RADIOGRAFIA CABEZA Y CUELLO"]); 
                column1Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA COLUMNA Y PELVIS", examenesPorCategoria["RADIOGRAFIA COLUMNA Y PELVIS"]); 
                column1Html += '</div>'; 
    
                // Columna 2: 
                column2Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA EXTREMIDADES", examenesPorCategoria["RADIOGRAFIA EXTREMIDADES"]);
                column2Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA PROCDIMIENTOS ESPECIALES INVASIVOS", examenesPorCategoria["RADIOGRAFIA PROCDIMIENTOS ESPECIALES INVASIVOS"]);
                column2Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA DE TORAX", examenesPorCategoria["RADIOGRAFIA DE TORAX"]);
                column2Html +=  EvaluacionEmergencia.generateExamenRayosXHtml("RADIOGRAFIA - VARIOS", examenesPorCategoria["RADIOGRAFIA - VARIOS"]);
                column2Html += '</div>'; 
            ...
            $.ajax({
                ...
                success: function (datos) {  
                    ...
                    */
                    ...
                    column1Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES HEMATOLÓGICOS", examenesPorCategoria["EXÁMENES HEMATOLÓGICOS"]);  
                    column1Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES BIOQUÍMICOS", examenesPorCategoria["EXÁMENES BIOQUÍMICOS"]); 
                    column1Html += '</div>'; // Cerrar columna 1
        
                    column2Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES INMUNOLÓGICOS", examenesPorCategoria["EXÁMENES INMUNOLÓGICOS"]);
                    column2Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES DE ORINA", examenesPorCategoria["EXÁMENES DE ORINA"]);
                    column2Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES EN LÍQUIDOS", examenesPorCategoria["EXÁMENES EN LÍQUIDOS"]);
                    column2Html += EvaluacionEmergencia.generateExamensHtml("EXÁMENES MICROBIOLÓGICOS - HECES", examenesPorCategoria["EXÁMENES MICROBIOLÓGICOS - HECES"]);
                    column2Html += EvaluacionEmergencia.generateExamensHtml("LABORATORIO - UCI", examenesPorCategoria["LABORATORIO - UCI"]);
        ...
        async listaExameneLabCentral(tipo) {
            ...
            $.ajax({
                ...
                success: function (datos) {  
                    ...
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("BIOQUIMICA", examenesPorCategoria["BIOQUIMICA"]);  
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("BIOQUIMICA ORINA", examenesPorCategoria["BIOQUIMICA ORINA"]); 
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("BIOQUIMICA FERTILIDAD", examenesPorCategoria["BIOQUIMICA FERTILIDAD"]);
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("HEMATOLOGIA", examenesPorCategoria["HEMATOLOGIA"]);
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("HEMOSTASIA Y TROMBOSIS", examenesPorCategoria["HEMOSTASIA Y TROMBOSIS"]);
                    column1Html += EvaluacionEmergencia.generateExamensCentralHtml("INMUNOL HORMONAS", examenesPorCategoria["INMUNOL HORMONAS"]);
                    column1Html += '</div>'; 
        
                 
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("INMUNOLO. HEPATICA", examenesPorCategoria["INMUNOLO. HEPATICA"]);
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("MARCAD. ONCOLOGICOS", examenesPorCategoria["MARCAD. ONCOLOGICOS"]);
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("INMUNOLOGIA", examenesPorCategoria["INMUNOLOGIA"]);
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("MICROBIOLOGIA", examenesPorCategoria["MICROBIOLOGIA"]);
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("BANCO DE SANGRE", examenesPorCategoria["BANCO DE SANGRE"]);
                    column2Html += EvaluacionEmergencia.generateExamensCentralHtml("LABORATORIO - UCI", examenesPorCategoria["LABORATORIO - UCI"]);
                    column2Html += '</div>'; 
...
>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406
    async GuardarEvaluacionEmergencia() {
        ...
        formData.append('Mac', $('#txtMAC').val());
        formData.append('Hta', $('#chkHta').is(":checked") ? 1 : 0);
        formData.append('Dm', $('#chkDm').is(":checked") ? 1 : 0);
        formData.append('Tbc', $('#chkTbc').is(":checked") ? 1 : 0);
        formData.append('Asma', $('#chkAsma').is(":checked") ? 1 : 0);
        formData.append('Hepatitis', $('#chkHepatitis').is(":checked") ? 1 : 0);
        formData.append('NtQx', $('#chkNtQx').is(":checked") ? 1 : 0);
        formData.append('Ram', $('#chkRam').is(":checked") ? 1 : 0);
        ...
        try {
            datos = await $.ajax({
                method: "POST",
                url: "/EvaluacionEmergencia/GuardarEvaluacion",
    ...
    async GuardarEvaluacionEmergenciaDetalle() {
        ...
        if (EvaluacionEmergencia.IdNumero == 0) {
            return false;
        }
        ...
        formData.append('IdAtencion', $('#hdnIdAtencion').val());
        formData.append('IdNumero', EvaluacionEmergencia.IdNumero);
        ...
        try {
            datos = await $.ajax({
                method: "POST",
                url: "/EvaluacionEmergencia/GuardarEvaluacionEmergenciaDetalle",
                //contentType: "application/json; charset=utf-8",
                data: formData,
                dataType: "json",
                cache: false,
            ...
            let evaluacionDetalle = await EvaluacionEmergencia.ListarEvaluacionEmergenciaDetalleByIdAtencion($('#hdnIdAtencion').val(), 0)
    ...
    async GuardarDiagnosticos() {
        ...
        formData.append('IdNumero', EvaluacionEmergencia.IdNumero);
        formData.append("IdServicio", $('#hdnIdServicio').val());
        formData.append('Diagnosticos', EvaluacionEmergencia.ObtenerDiagnosticos());
        ...
        try {
            datos = await $.ajax({
                method: "POST",
                url: "/EvaluacionEmergencia/GuardarDiagnosticos",
                //contentType: "application/json; charset=utf-8",
                data: formData,
                dataType: "json",
                cache: false,
    ...
    async CargarDatosEvaluacionDetalle() {
        ...
        EvaluacionEmergencia.IdNumero = objrowTb.IdNumero;
        ...
        let evaluacionDetalle = await EvaluacionEmergencia.ListarEvaluacionEmergenciaDetalleByIdAtencion($('#hdnIdAtencion').val(), objrowTb.IdNumero)
       console.log('evaluacionDetalle',evaluacionDetalle)
        await EvaluacionEmergencia.ListarDiagnosticos(objrowTb.IdNumero);
        ...
        //await OrdenMedica.CargarOrdenesMedicasPorIdCuentaAtencionPorEvaluacion(Variables.IdCuentaAtencion, EvaluacionEmergencia.IdNumero);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
<<<<<<< HEAD
        await ConsumoServicio.CargarOrdenesCPT(Variables.IdCuentaAtencion);
        await Resultados.CargarLaboratorioMovimientos(Variables.IdCuentaAtencion);
=======
        await ConsumoServicio.CargarOrdenesCPT(Variables.IdCuentaAtencion,objrowTb.IdNumero);
        await Resultados.CargarLaboratorioMovimientosAP(Variables.IdCuentaAtencion,Variables.NroEvaluacion);
         //await Resultados.CargarLaboratorioMovimientos( $("#hdIdPaciente").val()) // kds
         await Resultados.CargarLaboratorioMovimientos( Variables.IdCuentaAtencion) // kds

>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406

        // await Triaje.ListarTriajeEvaluacionEmergencia($('#hdnIdAtencion').val(), objrowTb.IdNumero)
        ...
        if (evaluacionDetalle[0].IdUsuario == Variables.IdUsuarioLogeado) {
            $("#btnGuardarEva").show();
        } else {
            $("#btnGuardarEva").hide();
        }
    ...
    Eventos() {
        ...
        $("#btnGuardarEva").on('click', async function () {
            ...
            console.log('dxs', dxs);
            console.log('EvaluacionEmergencia.IdNumero', EvaluacionEmergencia.IdNumero);
        ...
        $("#btnNuevoRegistro").on('click', async function () {
            ...
            if (Variables.IdMedicoLogeado > 0) {
                ...
                EvaluacionEmergencia.IdNumero = DtEvaluaciones.data().toArray().length + 1

                $("#BadgeEvaluacion").removeClass("alerta-primary");
                $("#BadgeEvaluacion").addClass("alerta-success");
                $("#CardEva").addClass("bg-blue");

                $("#lblNumeroEvaluacion").html("Evaluación N° " + EvaluacionEmergencia.IdNumero.toString());
                ...
                */
                ...
                await EvaluacionEmergencia.ListarDiagnosticos(EvaluacionEmergencia.IdNumero); //PGONZALESC
                await OrdenMedica.CargarOrdenesMedicasPorIdCuentaAtencionPorEvaluacion(Variables.IdCuentaAtencion, EvaluacionEmergencia.IdNumero);

                alerta('info', '', 'Paciente iniciara la Evaluación N° ' + EvaluacionEmergencia.IdNumero);
        ...
        $('#ImprimirEvalEmerSF').on('click', async function () {
            ...
            // let evaluacionDetalle = await EvaluacionEmergencia.ListarEvaluacionEmergenciaDetalleByIdAtencion(objrowTb.IdNumero)
            ...
            if(documentoFirmado.length > 0) {
                ...
                $.ajax({
                    url: '/EvaluacionEmergencia/informes/generarPDF/' + $('#hdnIdAtencion').val() + '?eval=' + objrowTb.IdNumero,
                    method: 'GET',
        ...
        $('#tblEvaluacionesEmergencia tbody').on('click', 'tr', async function () {
            ...
            if (!isEmpty(objrowTb)) {
                EvaluacionEmergencia.CargarDatosEvaluacionDetalle(objrowTb);
        ...
        $('.OpcionEvalEmer').on('click', function () {
            ...
            /*if (AdmisionEmergencia.accion == 'M') {
                if (EvaluacionEmergencia.idMedicoPrimeraEvaluacion > 0) {
                    if (EvaluacionEmergencia.idMedicoPrimeraEvaluacion == Utilitario.ObtenerIdMedicoSesion()) {
...
>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406
        ...
        DtDiagnosticos = $('#tblDiagnosticos').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    createdCell: function (td, cellData, rowData, row, col) {
                        $(td).attr('align', 'left')
                        $(td).html("<button class='btn btn-danger btnEliminarDiagnostico'>ELIMINAR</button>")
                    }
                }
            ]
        });
    ...
    DataTableEvaluaciones() {
        ...
        DtEvaluaciones = $('#tblEvaluacionesEmergencia').DataTable({
            scrollY: "145px",
            scrollCollapse: true,
            autoWidth: false,
            ordering: false,
    ...
    AgregarDiagnostico() {
        if (EvaluacionEmergencia.ExisteDiagnosticos()) {
            Swal.fire({
                icon: 'info',
    ...
    ObtenerDiagnosticos() {
        ...
        for (var i = 0; i < lstDiagnosticos.length; i++) {
            ...
            diagnosticos = diagnosticos + EvaluacionEmergencia.IdNumero + '@';            //IdEvaluacion
...
$(document).ready(function () {
    ...
    EvaluacionEmergencia.IniciarPlugins();
    EvaluacionEmergencia.Eventos();
    EvaluacionEmergencia.DataTableDiagnosticos();
    EvaluacionEmergencia.DataTableEvaluaciones();
    EvaluacionEmergencia.DatablesCuenta();
