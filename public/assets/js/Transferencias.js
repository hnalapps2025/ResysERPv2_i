    ...
    Eventos() {
        ...
        $("#btnTransferencia").on('click', async function () {
         ...
         $("#btnTransferencia_Hosp").on('click', async function () {
            console.log('entro tanferencia general');
            
            Transferencias.LimpiarModalTransferencias();
            await Transferencias.CargarTransferencia();     
            
        });
        $('#btnTransferencia_Hosp').modal('show').on('shown.bs.modal', function () {
        ...
        $("#btnGuardarTransferenciasConfirmacion").on('click', async function () {
            ...
            if (isEmpty($("#cboServicioEsperaTransferencia").val())) {
                alerta('info', '', 'Por favor selecciones el servicio que se asiganara al paciente.');
                return false;
            }

            // if(Transferencias.esObservacionEmergencia == 1 && Transferencias.tieneCama == true){
            //     if (isEmpty($("#cboCamaEsperaTransferencia").val())) {
            //         alerta('info', '', 'Por favor selecciones la cama que se asiganara al paciente.');
            //         return false;
            //     }
            // } 
