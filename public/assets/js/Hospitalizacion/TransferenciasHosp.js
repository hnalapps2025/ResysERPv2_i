...
var Transferencias = {
    ...
    Eventos() {
        ...
        $("#btnTransferencia_Hosp").on('click', async function () {
            console.log('transferencia dentro de Hosp');
            // var evals = DtEvaluaciones.data().count();
            // var dxs = DtDiagnosticos.data().count();
            listFilaAltaMedicaHosp
            console.log('333', listFilaAltaMedicaHosp);
            if (listFilaAltaMedicaHosp.length != 0) {
...
<<<<<<< HEAD:public/assets/js/Hospitalizacion/TransferenciasHosp.js
=======
...
>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406:public/assets/js/Hospitalizacion/Transferencias.js
        });

        $('#modalTransferencias').on('shown.bs.modal', function (event) {
            DTTransferencias.columns.adjust().draw();
        });
        ...
        $("#btnGuardarTransferencias").on('click', async function () {
            ...
            const aten = await Transferencias.SeleccionarAtencion(listFilaAltaMedica.IdAtencion);
            Transferencias.esObservacionEmergencia = aten.EsObservacionEmergencia;
...
<<<<<<< HEAD:public/assets/js/Hospitalizacion/TransferenciasHosp.js
            ...
            if (Transferencias.esObservacionEmergencia == 1 && Transferencias.tieneCama == true) {
=======
...
<<<<<<< HEAD:public/assets/js/Hospitalizacion/TransferenciasHosp.js
            console.log('trnasferencia', Transferencias.idEstanciaHospitalariaActual, $("#cboCamaEsperaTransferencia").val());
...
<<<<<<< HEAD:public/assets/js/Hospitalizacion/TransferenciasHosp.js
                if (Transferencias.tipoServicio == 'EMER') {
                    ...
                    //window.location.href = '../t_atencion/' + Variable.IdServicio;
                    //AdmisionEmergencia.ListarAtenciones(AdmisionEmergencia.tipoBusqueda);
                }
                if (Transferencias.tipoServicio == 'HOSP') {
                    window.location.href = '../HospitalizacionEvaluacion/' + listFilaAltaMedica.IdAtencion;
        ...
        $("#btnCerrarTransferenciasConfirmacion").on('click', function () {
            ...
            Transferencias.CerrarModalTransferenciasConfirmacion();
            window.location.href = '../Emergencia/Emergencia/' + 0;
=======
...
>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406:public/assets/js/Hospitalizacion/Transferencias.js
    ...
    async CargarTransferencia() {
        ...
        await Transferencias.ListarCamas(listFilaAltaMedica.IdServicioActual);
    ...
    LimpiarModalTransferencias() {
        console.log('trnaasferenci dentro de Trasn hosp');
