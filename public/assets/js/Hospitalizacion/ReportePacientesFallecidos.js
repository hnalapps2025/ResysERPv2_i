var Epicrisis = {
    ...
    async ListarAltasSinDiagnosticos(data) {
        ...
        await fetch(
            `/hospitalizacion/listarPacientesFallecidos`,
            {
                method: "POST",
                headers: {
...
async function pacienteFallecidoPDF(data) {
    ...
    try {
        ...
        const response = await fetch(
            "/hospitalizacion/generarPDFPacienteFallecido",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
function cargarAltasPacientesFallecidos(){
...
$(document).ready(function () {
    ...
    $("#btnBuscar").on("click", function () {
        ...
        if($("#cboMes").val()== 0){
            ...
            cargarAltasPacientesFallecidos();
        }
    });
    
    $("#btnExportarExcel").click(async function () {
        let titulo =
            "REPORTE DE PACIENTES FALLECIDOS  AÑO " +
            $("#cboAnio").val() + " MES " +  $("#cboMes option:selected").text();
        ...
        let headers = [
            "N° Historia","Paciente" ,"Servicio","Especialidad","Cama", "Fecha Ingreso", "Fecha Egreso", "24HORAS"
        ];
        ...
        let columnasDeseadas = [
            "NroHistoriaClinica","Paciente" ,"Servicio","Especialidad","Cama","FechaIngreso","FechaEgreso","24HORAS",
