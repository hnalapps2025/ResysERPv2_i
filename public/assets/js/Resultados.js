...
=======
    ...
    async CargarLaboratorioMovimientos(IdCuentaAtencion) { 
        // var resp = [];
>>>>>>> c43206bf175774a3bfc1e1fc1e2cd58a60d1e406
        let datos;
        var data = new FormData();
        console.log('CargarMovimientosLaboratoriodd')
    ...
    async CargarLaboratorioMovimientosAP(IdCuentaAtencion,NumEvaluacion) { 
        // var resp = [];
        let datos;
        var data = new FormData();
        console.log('CargarMovimientosLaboratoriodd')
        ...
        try {
            ...
            datos = await
                $.ajax({
                    method: "POST",
                    url: "/Resultados/CargarMovimientosLaboratorioAP",
                    data: data,
                    dataType: "json",
                    cache: false,
                    processData: false,
